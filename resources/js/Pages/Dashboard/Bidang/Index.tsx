...
export default function Bidang({ bidangs }: { bidangs: Bidang[] }) {
  const data: Bidang[] = bidangs;
  ...
  const [idBidang, setIdBidang] = useState<string | undefined>(undefined);

  const columns: ColumnDef<Bidang>[] = [
    {
      accessorKey: 'id',
      header: 'ID',
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end">
                ...
                <DropdownMenuItem>
                  <Link
                    className="w-full"
                    href={route('dashboard.bidang.edit', row.getValue('id'))}
                  >
                    Ubah
                  </Link>
                </DropdownMenuItem>
  ...
  const deleteItem = () => {
    router.delete(route('dashboard.bidang.destroy', idBidang), {
      onSuccess: () => {
        setIsDeleteDialogOpen(false);
        setIdBidang(undefined);
        toast({
          title: 'Berhasil!',
          description: 'Bidang berhasil di hapus.'
        });
      },
      onError: err => {
        setIsDeleteDialogOpen(false);
  ...
  return (
    <AuthenticatedLayout>
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              menghapus bidang Anda dan menghilangkan data Anda dari server.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
      ...
      <div>
        <Button asChild>
          <Link href={route('dashboard.bidang.create')}>Buat Bidang</Link>
        </Button>
        <div className="w-full">
          <div className="flex items-center py-4">
            <Input
              ...
              onChange={bidang =>
                table.getColumn('name')?.setFilterValue(bidang.target.value)
              }
              className="max-w-sm"
            />
            <DropdownMenu>
