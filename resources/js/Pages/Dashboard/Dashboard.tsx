                  ...
                  <div className="overflow-x-auto">
                    <Table>
                      ...
                      <TableBody>
                        ...
                        <TableRow>
                          <TableCell className="text-xs">
                            Penyerapan Tenaga Kerja Industri Kecil Menengah
                            (IKM)
                          </TableCell>
                          <TableCell className="text-right text-xs">
                            13,904
                        ...
                        <TableRow>
                          <TableCell className="text-xs">
                            Proporsi nilai tambah IKM terhadap total nilai
                            tambah industri
                          </TableCell>
                          <TableCell className="text-right text-xs">
                            98.29
                        ...
                        <TableRow>
                          <TableCell className="text-xs">
                            Sentra Industri Kecil dan Menengah (IKM) di Luar
                        ...
                        <TableRow>
                          <TableCell className="text-xs">
                            Perusahaan Industri Menengah Besar Yang
