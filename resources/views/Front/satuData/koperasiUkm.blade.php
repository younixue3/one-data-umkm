            ...
            <div class="flex justify-between h-16">
                <div class="flex">
                    ...
                    <div class="hidden sm:ml-6 sm:flex sm:space-x-8">
                        ...
                        <a href="/satu-data/koperasi-ukm" class="inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium border-indigo-500 text-indigo-600">Koperasi dan UKM</a>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
                                <div class="bg-white rounded-lg shadow-md overflow-hidden">
                                    <div class="border-b border-gray-200 px-4 py-3">
                                        <h6 class="text-center text-gray-800 font-medium">Jumlah Koperasi Berdasarkan Kabupaten/Kota</h6>
                                    </div>
                                    <div class="p-4">
                                ...
                                <div class="bg-white rounded-lg shadow-md overflow-hidden">
                                    <div class="border-b border-gray-200 px-4 py-3">
                                        <h6 class="text-center text-gray-800 font-medium">Jumlah UKM Berdasarkan Jenis Usahanya</h6>
                                    </div>
                                    <div class="p-4">
                                ...
                                <div class="col-span-1 md:col-span-2 bg-white rounded-lg shadow-md overflow-hidden">
                                    <div class="border-b border-gray-200 px-4 py-3">
                                        <h6 class="text-center text-gray-800 font-medium">Data Koperasi dan UKM</h6>
                                    </div>
                                    <div class="p-4">
                                        <div class="overflow-x-auto">
                                            <table class="min-w-full divide-y divide-gray-200">
                                                ...
                                                <tbody class="bg-white divide-y divide-gray-200">
                                                    <tr>
                                                        <td class="px-3 py-2 text-xs text-gray-700">Jumlah Koperasi Aktif</td>
                                                        <td class="px-3 py-2 text-xs text-gray-700 text-right">456</td>
                                                        <td class="px-3 py-2 text-xs text-gray-700 text-right">478</td>
                                                        <td class="px-3 py-2 text-xs text-gray-700 text-right">492</td>
                                                        <td class="px-3 py-2 text-xs text-gray-700 text-right">510</td>
                                                    </tr>
                                                    <tr>
                                                        <td class="px-3 py-2 text-xs text-gray-700">Jumlah Anggota Koperasi</td>
                                                        <td class="px-3 py-2 text-xs text-gray-700 text-right">24,567</td>
                                                        <td class="px-3 py-2 text-xs text-gray-700 text-right">26,890</td>
                                                        <td class="px-3 py-2 text-xs text-gray-700 text-right">28,345</td>
                                                        <td class="px-3 py-2 text-xs text-gray-700 text-right">30,120</td>
                                                    </tr>
                                                    <tr>
                                                        <td class="px-3 py-2 text-xs text-gray-700">Volume Usaha Koperasi (Rp Miliar)</td>
                                                        <td class="px-3 py-2 text-xs text-gray-700 text-right">245.6</td>
                                                        <td class="px-3 py-2 text-xs text-gray-700 text-right">267.8</td>
                                                        <td class="px-3 py-2 text-xs text-gray-700 text-right">298.3</td>
                                                        <td class="px-3 py-2 text-xs text-gray-700 text-right">325.7</td>
                                                    </tr>
                                                    <tr>
                                                        <td class="px-3 py-2 text-xs text-gray-700">Jumlah UKM</td>
                                                        <td class="px-3 py-2 text-xs text-gray-700 text-right">12,345</td>
                                                        <td class="px-3 py-2 text-xs text-gray-700 text-right">13,567</td>
                                                        <td class="px-3 py-2 text-xs text-gray-700 text-right">14,890</td>
                                                        <td class="px-3 py-2 text-xs text-gray-700 text-right">16,234</td>
                                                    </tr>
                                                    <tr>
                                                        <td class="px-3 py-2 text-xs text-gray-700">Penyerapan Tenaga Kerja UKM</td>
                                                        <td class="px-3 py-2 text-xs text-gray-700 text-right">34,567</td>
                                                        <td class="px-3 py-2 text-xs text-gray-700 text-right">36,789</td>
                                                        <td class="px-3 py-2 text-xs text-gray-700 text-right">39,456</td>
                                                        <td class="px-3 py-2 text-xs text-gray-700 text-right">42,890</td>
                                                    </tr>
                                                    <tr>
                                                        <td class="px-3 py-2 text-xs text-gray-700">Kontribusi UKM terhadap PDRB (%)</td>
                                                        <td class="px-3 py-2 text-xs text-gray-700 text-right">8.45</td>
                                                        <td class="px-3 py-2 text-xs text-gray-700 text-right">8.67</td>
                                                        <td class="px-3 py-2 text-xs text-gray-700 text-right">9.12</td>
                                                        <td class="px-3 py-2 text-xs text-gray-700 text-right">9.56</td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const verticalBarData = [
            { name: 'Semua Kabupaten/Kota', '2020': 456, '2021': 478, '2022': 492, '2023': 510 },
            { name: 'KABUPATEN BULUNGAN', '2020': 120, '2021': 125, '2022': 130, '2023': 135 },
            { name: 'KABUPATEN MALINAU', '2020': 85, '2021': 90, '2022': 92, '2023': 95 },
            { name: 'KABUPATEN NUNUKAN', '2020': 95, '2021': 100, '2022': 105, '2023': 110 },
            { name: 'KABUPATEN TANA TIDUNG', '2020': 56, '2021': 58, '2022': 60, '2023': 62 },
            { name: 'KOTA TARAKAN', '2020': 100, '2021': 105, '2022': 105, '2023': 108 }
        ];

        const industryData = [
            { name: 'Perdagangan', '2020': 4560, '2021': 4890, '2022': 5230, '2023': 5670 },
            { name: 'Kuliner', '2020': 3250, '2021': 3580, '2022': 3920, '2023': 4350 },
            { name: 'Kerajinan', '2020': 1890, '2021': 2050, '2022': 2180, '2023': 2340 },
            { name: 'Jasa', '2020': 1450, '2021': 1680, '2022': 1950, '2023': 2230 },
            { name: 'Pertanian', '2020': 1195, '2021': 1367, '2022': 1610, '2023': 1644 }
        ];
