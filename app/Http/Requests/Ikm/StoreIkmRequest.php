...
class StoreIkmRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'kelurahan_id.string' => 'Kelurahan tidak valid',
            'kecamatan_id.required' => 'Kecamatan harus dipilih',
            'kecamatan_id.string' => 'Kecamatan tidak valid',
            'kabupaten_id.required' => 'Kabupaten harus dipilih',
            'kabupaten_id.string' => 'Kabupaten tidak valid',
            'provinsi_id.required' => 'Provinsi harus dipilih',
            'provinsi_id.string' => 'Provinsi tidak valid',
            'email.string' => 'Format email tidak valid',
            'jenis_usaha_id.required' => 'Jenis usaha harus dipilih',
            'jenis_usaha_id.string' => 'Jenis usaha tidak valid',
            'jenis_produk_id.required' => 'Jenis produk harus dipilih',
            'jenis_produk_id.string' => 'Jenis produk tidak valid',
