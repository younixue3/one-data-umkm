...
class BidangController extends Controller
{
     ...
     */
    public function index(BidangServices $bidangServices): \Inertia\Response|\Inertia\ResponseFactory
    {
        // $bidangs = $bidangServices->index();
        return inertia("Informasi/Bidang/Index");
    }
